var SetPet = (function () {
    ...
    SetPet.prototype.Show = function () {
        var _this = this;
        System.GetConnection().GetRanking(function (userList) {
            return _this.UserListReady(userList);
        });
    };

    SetPet.prototype.UserListReady = function (userList) {
    ...
    SetPet.prototype.Click = function () {
        ...
        }, $("#select-choice-1 option:selected").text());
...
var MiniGameResult = (function () {
    function MiniGameResult() {
        $("#minigameresultbutton").bind('click', function (score, cancelled) {
            return Game.CloseMiniGameResult();
        });
    }
    MiniGameResult.prototype.Show = function (score, id, action) {
        this.score = score;
...
var Ranking = (function () {
    function Ranking() {
        ...
        $('#minigamesHighscores').on('click', function () {
            Game.ShowHighScores();
        });
    ...
    Ranking.prototype.RankingReady = function (val) {
        ...
        var html = "<tr class=\"ui-bar-d\" ><th data-priority = \"3\" >Place</th > <th data-priority = \"1\" > Name </th > <th data-priority = \"2\" > Score </th > < / tr>";
...
var Highscores = (function () {
    function Highscores() {
        $("#hsbackbutton").on('click', function () {
            Game.ChangePage();
        });
        $("#cookingHS").on('click', function () {
            Highscore.LoadHighscores(1);
        });
        $("#frogHS").on('click', function () {
            Highscore.LoadHighscores(2);
        });
        $("#currentHS").on('click', function () {
            Highscore.LoadHighscores(3);
        });
        $("#whackHS").on('click', function () {
            Highscore.LoadHighscores(4);
        });
    }
