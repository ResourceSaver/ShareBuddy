var Minigame = (function () {
    function Minigame() {
        ...
        $("#closeMinigame").on("click", function () {
            return _this.StopMiniGame(true);
        });
    }
    ...
    Minigame.prototype.StopMiniGame = function (cancelled) {
        var _this = this;
        this.selectedMiniGame.Act();

        Game.SetMain();
        setTimeout(function () {
            Game.ShowMiniGameResult(_this.selectedMiniGame.GetScore(), cancelled, _this.selectedMiniGame.GetId());
        }, 2000);
    };
    return Minigame;
})();
