var AnimationWrapper = (function () {
    function AnimationWrapper() {
        ...
        this.animationPasta = new Animation(animationData, 30 /* Slow */, 0 /* horizontal */, 1, 0, 2);
        this.animationTv = new Animation(animationData, 30 /* Slow */, 0 /* horizontal */, 0, 3, 3);
        this.animationEReader = new Animation(animationData, 30 /* Slow */, 0 /* horizontal */, 0, 0, 2);
        this.animationShower = new Animation(animationData, 30 /* Slow */, 0 /* horizontal */, 1, 3, 3);
        ...
        this.animationSun = new Animation(animationData, 30 /* Slow */, 0 /* horizontal */, 3, 0, 3);
        this.animationTMill = new Animation(animationData, 30 /* Slow */, 0 /* horizontal */, 3, 3, 3);
        this.animationBrushteeth = new Animation(animationData, 10 /* Medium */, 0 /* horizontal */, 4, 0, 3);
        this.animationDumbell = new Animation(animationData, 30 /* Slow */, 0 /* horizontal */, 4, 3, 3);
        this.animationPopcorn = new Animation(animationData, 30 /* Slow */, 0 /* horizontal */, 5, 0, 3);
