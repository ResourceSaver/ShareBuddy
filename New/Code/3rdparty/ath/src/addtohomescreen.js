...
ath.intl = {
	de_de: {
		...
		android: 'To add <strong>ShareBuddy</strong> to the home screen, tapp the top right menu icon <span class="ath-action-icon">icon</span> and select <strong>Add to homescreen</strong>.',
	},
